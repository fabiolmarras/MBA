...
#' 
acao_investimento$eventos[1] <- acao_investimento$recomendacao_adx[1]
for(i in 2:nrow(acao_investimento))
{
  if (acao_investimento$recomendacao_adx[i] != acao_investimento$recomendacao_adx[i-1])
  {
    acao_investimento$eventos[i] <- acao_investimento$recomendacao_adx[i]
  } else {
...
# rm(valor_final_sem_tecnica, valor_final_conta, valor_inicial_acao, valor_inicial_conta, valor_final_acao)
